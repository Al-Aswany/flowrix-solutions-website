    ...
    <section className="bg-white px-5 py-5 sm:px-8 sm:py-8 lg:px-12">
      <div className="relative mx-auto max-w-[1400px] overflow-hidden rounded-[28px] bg-[#07110f] px-6 py-20 text-white sm:px-12 sm:py-28 lg:px-20 lg:py-32">
        ...
        <div className="relative max-w-4xl">
          <p className="section-label text-[#4ce5c8]">Let&apos;s talk</p>
          <h2 className="mt-6 text-4xl font-medium leading-[1.02] tracking-[-0.05em] sm:text-6xl lg:text-[74px]">Tell us how your business actually runs.</h2>
          <p className="mt-7 max-w-2xl text-base leading-8 text-white/50 sm:text-lg">A 30-minute conversation with someone who wants to understand the work—where it slows down, where data gets lost, what you need next. No slides unless you ask. Just an honest answer on whether we can help.</p>
